...
Accuracy:
svhn_multi_gpu_train.py achieves ~86% accuracy after 100K steps (256
epochs of data) as judged by svhn_eval.py.
...
tf.app.flags.DEFINE_string('train_dir', '/tmp/svhn_train',
